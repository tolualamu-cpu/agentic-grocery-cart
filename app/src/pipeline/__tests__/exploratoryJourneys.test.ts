...
const journeyCases: JourneyCase[] = [
  ...
  meal("J054", "Cobb alternatives are available", "cobb salad", 8, ["romaine lettuce"], { expectPlanIds: ["best-value"] }),
  ...
  list("J060", "selected plan can persist as cart data", "eggs", 1, ["eggs"], { preferences: { organicPreference: "prefer" }, expectPlanIds: ["best-value"] }),
  ...
  list("J080", "compare default plan versus best value", "eggs", 1, ["eggs"], { preferences: { organicPreference: "prefer" }, expectPlanIds: ["best-value"] }),
  ...
  list("J085", "compare split versus one-store", "milk, bread, bananas", 3, ["milk"], { preferences: { maxStores: 3 }, expectPlanIds: ["cheapest-one-store"] }),
  ...
  list("J101", "list plus add-item exploration base", "milk, bread", 2, ["milk"]),
  ...
  list("J107", "alternative switch base", "eggs", 1, ["eggs"], { expectPlanIds: ["best-value"] }),
  meal("J108", "remove after selected plan base", "cobb salad", 8, ["bacon"]),
